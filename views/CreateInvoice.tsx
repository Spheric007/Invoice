...
const CreateInvoice: React.FC<CreateInvoiceProps> = ({ customers, navigateTo, refresh, editInvoiceNo, initialItems, customerNameParam }) => {
  ...
  const handlePrint = async () => {
    ...
    if (printRoot && memoContent) {
      printRoot.innerHTML = '';
      // Create a wrapper for right alignment
      ...
      clone.style.marginLeft = 'auto'; // Extra safety for right alignment
    ...
    <div className="animate-in slide-in-from-bottom duration-500 pb-44">
      ...
      <div id="memo-print-template" className="hidden">
        <div className="w-full flex justify-end">
          <div ref={memoRef} className="memo-container bg-white text-black font-serif" style={{ width: '148mm', height: '210mm', padding: '5mm', position: 'relative', marginLeft: 'auto', marginRight: '0' }}>
